public class EscapeSequencesComments
{
    public static void main( String[] args)
    {
        ...
        //and comments. :)
        // I am trying to see if the block comment will work on Line 13
        /* I had a block comment on Line 13 in the "println" word, but the code wouldn't compile.
        So, I had to take it out. We'll see if the code works now. */
    }
}
